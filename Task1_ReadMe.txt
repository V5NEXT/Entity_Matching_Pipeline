...
used to rename the venue values from one column to the venue values of the other column, and vice-versa.

2) File Task1.2.py
By having  column 'venue' of one schema renamed to the values of the other one, an efficent blocking scheme can be implemented  based on  having exactly the same
values on attributes: 'venue', 'year'. This is a sort of a hybrid blocking, because, essentially it is based on a string distance between the values(venues)-
